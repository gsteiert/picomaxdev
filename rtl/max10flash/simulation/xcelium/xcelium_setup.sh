...
# ACDS 23.1 991 linux 2025.02.08.08:01:37
...
# ----------------------------------------
# If max10flash is one of several IP cores in your
...
TOP_LEVEL_NAME="max10flash"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/greg/intelFPGA_lite/23.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_INSTALL_DIR/eda/sim_lib/cadence/fiftyfivenm_atoms_ncrypt.v" -work fiftyfivenm_ver 
fi

# ----------------------------------------
# compile design files in correct order
if [ $SKIP_COM -eq 0 ]; then
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_onchip_flash_util.v"                 -work onchip_flash_0 -cdslib ./cds_libs/onchip_flash_0.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_onchip_flash.v"                      -work onchip_flash_0 -cdslib ./cds_libs/onchip_flash_0.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_onchip_flash_avmm_data_controller.v" -work onchip_flash_0 -cdslib ./cds_libs/onchip_flash_0.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/max10flash.v"                                                                                                        
fi
